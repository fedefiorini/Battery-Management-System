...
/**
 * @brief	Indicator of eventual I2C failures during communication.
 * 			It's used during communication between the LPC and the BQ76930
 * 			and avoids waiting forever for an I2C communication to happen,
 * 			and inform the microcontroller that something went wrong.
 */
#define I2C_FAIL_TIMEOUT		0xFFFF
